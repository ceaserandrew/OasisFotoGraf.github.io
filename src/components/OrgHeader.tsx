...
export default function OrgHeader({ org, loading, onRefresh, refreshing }: OrgHeaderProps) {
  return (
    <header className="relative w-full border-b border-white/10 bg-[#0A0A0A] py-8 px-4 sm:px-6 md:px-8 z-30 font-sans">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center md:items-end justify-between gap-6">
        ...
        <div className="flex flex-col sm:flex-row items-center sm:items-center text-center sm:text-left gap-6">
          {loading ? (
            <div className="w-16 h-16 sm:w-20 sm:h-20 bg-zinc-900 animate-pulse border border-white/10" />
          ) : (
            <div className="relative group shrink-0">
              ...
              <img
                ...
                className="relative w-16 h-16 sm:w-20 sm:h-20 rounded-none border border-white/10 object-cover shadow-2xl transition duration-300 group-hover:border-white/30"
              />
            </div>
          )}
          ...
          <div className="flex flex-col justify-center">
            {loading ? (
              ...
              <>
                ...
                <h1 className="text-3xl sm:text-4xl font-serif italic tracking-tight text-[#EAEAEA] mb-2 font-medium">
                ...
                <div className="flex flex-wrap justify-center sm:justify-start items-center gap-4 text-[10px] uppercase tracking-[0.15em] font-medium text-zinc-500">
        ...
        <div className="flex items-center gap-3 shrink-0">
          <button
            ...
            className="flex items-center gap-2.5 px-5 py-3 rounded-none bg-white text-black font-mono text-[10px] uppercase tracking-[0.2em] font-bold hover:bg-[#D1D1D1] transition duration-200 cursor-pointer disabled:opacity-50"
